...
type CleanupPolicyInformer interface {
	...
	Lister() v1alpha2.CleanupPolicyLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KyvernoV1alpha2().CleanupPolicies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KyvernoV1alpha2().CleanupPolicies(namespace).Watch(context.TODO(), options)
			},
		},
		&kyvernov1alpha2.CleanupPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *cleanupPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kyvernov1alpha2.CleanupPolicy{}, f.defaultInformer)
}

func (f *cleanupPolicyInformer) Lister() v1alpha2.CleanupPolicyLister {
	return v1alpha2.NewCleanupPolicyLister(f.Informer().GetIndexer())
}
