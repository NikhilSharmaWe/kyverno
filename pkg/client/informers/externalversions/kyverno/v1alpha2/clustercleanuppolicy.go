...
type ClusterCleanupPolicyInformer interface {
	...
	Lister() v1alpha2.ClusterCleanupPolicyLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KyvernoV1alpha2().ClusterCleanupPolicies().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KyvernoV1alpha2().ClusterCleanupPolicies().Watch(context.TODO(), options)
			},
		},
		&kyvernov1alpha2.ClusterCleanupPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterCleanupPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kyvernov1alpha2.ClusterCleanupPolicy{}, f.defaultInformer)
}

func (f *clusterCleanupPolicyInformer) Lister() v1alpha2.ClusterCleanupPolicyLister {
	return v1alpha2.NewClusterCleanupPolicyLister(f.Informer().GetIndexer())
}
